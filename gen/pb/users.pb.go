...
const file_api_proto_users_proto_rawDesc = "" +
	"\n" +
	"\x15api/proto/users.proto\x12\x06gen.pb\"H\n" +
	"\x04User\x12\x0e\n" +
	...
	"\x05login\x18\x01 \x01(\tR\x05login\"I\n" +
	"\x0fGetUserResponse\x12 \n" +
	"\x04user\x18\x01 \x01(\v2\f.gen.pb.UserR\x04user\x12\x14\n" +
	"\x05error\x18\x02 \x01(\tR\x05error2\xc4\x01\n" +
	"\x05Users\x12I\n" +
	"\fRegisterUser\x12\x1b.gen.pb.RegisterUserRequest\x1a\x1c.gen.pb.RegisterUserResponse\x124\n" +
	"\x05Login\x12\x14.gen.pb.LoginRequest\x1a\x15.gen.pb.LoginResponse\x12:\n" +
	"\aGetUser\x12\x16.gen.pb.GetUserRequest\x1a\x17.gen.pb.GetUserResponseB-Z+github.com/paranoiachains/gophkeeper/gen/pbb\x06proto3"
...
var file_api_proto_users_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_api_proto_users_proto_goTypes = []any{
	(*User)(nil),                 // 0: gen.pb.User
	(*RegisterUserRequest)(nil),  // 1: gen.pb.RegisterUserRequest
	(*RegisterUserResponse)(nil), // 2: gen.pb.RegisterUserResponse
	(*LoginRequest)(nil),         // 3: gen.pb.LoginRequest
	(*LoginResponse)(nil),        // 4: gen.pb.LoginResponse
	(*GetUserRequest)(nil),       // 5: gen.pb.GetUserRequest
	(*GetUserResponse)(nil),      // 6: gen.pb.GetUserResponse
}
var file_api_proto_users_proto_depIdxs = []int32{
	0, // 0: gen.pb.GetUserResponse.user:type_name -> gen.pb.User
	1, // 1: gen.pb.Users.RegisterUser:input_type -> gen.pb.RegisterUserRequest
	3, // 2: gen.pb.Users.Login:input_type -> gen.pb.LoginRequest
	5, // 3: gen.pb.Users.GetUser:input_type -> gen.pb.GetUserRequest
	2, // 4: gen.pb.Users.RegisterUser:output_type -> gen.pb.RegisterUserResponse
	4, // 5: gen.pb.Users.Login:output_type -> gen.pb.LoginResponse
	6, // 6: gen.pb.Users.GetUser:output_type -> gen.pb.GetUserResponse
